...
function doPost(e) {
  try {
    ...
    appendRow([timestamp, name, businessName, whatsapp, industry, monthlyInquiries, SOURCE]);
...
function doGet() {
  return ContentService.createTextOutput('AI Sales Agent lead endpoint is live.')
